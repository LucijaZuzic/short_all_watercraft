...
for mod_use in modes:
    ...
    predicted_all = load_object("pytorch_result/" + mod_use + "/predicted_all")
    y_test_all = load_object("pytorch_result/" + mod_use + "/y_test_all")
    ws_all = load_object("pytorch_result/" + mod_use + "/ws_all")

    actual_long = load_object("pytorch_result/" + mod_use + "/actual_long")
    actual_lat = load_object("pytorch_result/" + mod_use + "/actual_lat")
    predicted_long = load_object("pytorch_result/" + mod_use + "/predicted_long")
    predicted_lat = load_object("pytorch_result/" + mod_use + "/predicted_lat")

    distance_predicted_new = dict()

    if os.path.isfile("pytorch_result/" + mod_use + "/distance_predicted_new"):
        distance_predicted_new = load_object("pytorch_result/" + mod_use + "/distance_predicted_new")

    metric_names = ["euclidean"] 

    if not os.path.isdir("mosaic_pytorch/" + mod_use):
        os.makedirs("mosaic_pytorch/" + mod_use)

    if not os.path.isdir("mosaic_pytorch_all/" + mod_use):
        os.makedirs("mosaic_pytorch_all/" + mod_use)
                        ...
                        for v in set(int_veh):
                            ...
                            for k in predicted_long[model_name][ws_use][hidden_use][dist_name]:
                                ...
                                if use_draw:
                                    ...
                                    filename = "mosaic_pytorch_all/" + mod_use + "/Vehicle_" + vehicle + "_events_" + ride + "_" + model_name + "_" + str(ws_use) + "_" + str(hidden_use) + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
                            ...
                            if use_draw:
                                ...
                                filename_veh = "mosaic_pytorch/" + mod_use + "/Vehicle_" + str(v) + "_" + model_name + "_" + str(ws_use) + "_" + str(hidden_use) + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
                                draw_mosaic(all_actual_vehicle, all_predicted, filename_veh)

                        if use_draw:

                            filename = "mosaic_pytorch/" + mod_use + "/all_" + model_name + "_" + str(ws_use) + "_" + str(hidden_use) + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
    ...
    save_object("pytorch_result/" + mod_use + "/distance_predicted_new", distance_predicted_new)
