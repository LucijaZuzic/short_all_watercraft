...
def read_heading(nf1, nf2): 
    ...
    for subdir_name in all_subdirs: 
        ...
        train_rides = set()
        if os.path.isfile(subdir_name + "/train_rides_" + str(nf1 + 1) + "_" + str(nf2 + 1)):
            train_rides = load_object(subdir_name + "/train_rides_" + str(nf1 + 1) + "_" + str(nf2 + 1))
        val_rides = set()
        ...
        for some_file in all_files:  
            if subdir_name + "/cleaned_csv/" + some_file in bad_rides_filenames or subdir_name + "/cleaned_csv/" + some_file in gap_rides_filenames or some_file in train_rides or some_file in val_rides: 
                continue
    ...
    save_object("actual/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_direction", all_mine)
...
def read_latitude_no_abs(nf1, nf2): 
    ...
    save_object("actual/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_latitude_no_abs", all_mine)
...
def read_longitude_no_abs(nf1, nf2): 
    ...
    save_object("actual/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_longitude_no_abs", all_mine)
...
def read_speed(nf1, nf2): 
    ...
    save_object("actual/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_speed", all_mine)
...
def read_time(nf1, nf2): 
    ...
    save_object("actual/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_time", all_mine)
