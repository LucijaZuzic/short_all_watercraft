...
start_of_table = "\\begin{table*}[!t]\n\t\\begin{center}\n\t\t\\caption{METRICNAME for the trajectories in the training dataset estimated using VARNAME, different RNN models, and different window sizes.}\n\t\t\\label{tab:train_VARNAME_METRICNAME}\n\t\t\\resizebox{\linewidth}{!}{"
