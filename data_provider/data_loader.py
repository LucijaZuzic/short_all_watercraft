...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        df_raw = pd.read_csv(os.path.join(self.root_path,
                                          self.data_path))
        if "newdata" in self.data_path or "extended" in self.data_path:
            df_raw_train = pd.read_csv(os.path.join(self.root_path,
                                            self.data_path.replace("ALL", "TRAIN").replace("extended", "newdata")))
            df_raw_test = pd.read_csv(os.path.join(self.root_path,
                                            self.data_path.replace("ALL", "TEST")))
            df_raw_val = pd.read_csv(os.path.join(self.root_path,
                                            self.data_path.replace("ALL", "VAL").replace("extended", "newdata")))
