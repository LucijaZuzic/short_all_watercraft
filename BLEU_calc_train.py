...
for varname in os.listdir("train_attention1"):
    ...
    for test_num in range(1, 69):
        ...
        for model_name in os.listdir("train_attention" + str(test_num) + "/" + varname + "/predictions/train/"):
            ...
            for filename in os.listdir("train_attention" + str(test_num) + "/" + varname + "/predictions/train/" + model_name):
    
                final_test_data = pd.read_csv("train_attention" + str(test_num) + "/" + varname + "/predictions/train/" + model_name + "/" + filename, sep = ";", index_col = False)
                ...
                for k in file_object_test:
                    ...
                    save_object("attention_result_train/BLEU_all", BLEU_all) 
