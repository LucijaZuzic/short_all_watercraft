...
dicti_all = load_object("dicti_all_traj_val")
...
start_of_table = "\\begin{table*}[!t]\n\t\\begin{center}\n\t\t\\caption{METRICNAME for the trajectories in the validation dataset estimated using VARNAME, different RNN models, and different window sizes.}\n\t\t\\label{tab:val_VARNAME_METRICNAME}\n\t\t\\resizebox{\linewidth}{!}{"
