...
for nf1 in range(sf1):
    ...
    for nf2 in range(sf2):
        ...
        for mod_use in modes:
            ...
            if os.path.isfile("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/predicted_lat"):
                continue
            else:
                print(str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use)

            if os.path.isfile("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/predicted_all"):
                predicted_all = load_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/predicted_all")
                
            if os.path.isfile("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/y_test_all"):
                y_test_all = load_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/y_test_all")

            if os.path.isfile("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/ws_all"):
                    ...
                    for ws_use in ws_range:
                        ...
                        for hidden_use in hidden_range:
                            ...
                            if varname != "time":
                                    ...
                                    final_test_data = pd.read_csv("train_pytorch/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/" + varname + "/predictions/test/" + model_name_short + "/" + varname + "_" + model_name_short + "_ws_" + str(ws_use) + "_hidden_" + str(hidden_use) + "_test.csv", sep = ";", index_col = False)
                            ...
                            for k in file_object_test:
                                ...
                                if varname != "time":
                                    ...
                                    predicted_all[varname][model_name][ws_use][hidden_use][k] = y_test_all[varname][model_name][ws_use][hidden_use][k]
                                    
                                len_total += len(y_test_all[varname][model_name][ws_use][hidden_use][k])  

            if not os.path.isdir("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use):
                os.makedirs("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use)

            save_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/predicted_all", predicted_all)
            save_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/y_test_all", y_test_all)
            save_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/ws_all", ws_all)
            ...
            if os.path.isfile("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/predicted_long"):
            ...
            if os.path.isfile("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/actual_long"):
                actual_long = load_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/actual_long")

            if os.path.isfile("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/actual_lat"):
            ...
            save_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/actual_long", actual_long)
            save_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/actual_lat", actual_lat)
            save_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/predicted_long", predicted_long)
            save_object("pytorch_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + mod_use + "/predicted_lat", predicted_lat)