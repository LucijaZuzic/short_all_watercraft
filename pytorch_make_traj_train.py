...
for mod_use in modes:
    ...
    if os.path.isfile("pytorch_result_train/" + mod_use + "/predicted_all"):
        predicted_all = load_object("pytorch_result_train/" + mod_use + "/predicted_all")
        
    if os.path.isfile("pytorch_result_train/" + mod_use + "/y_test_all"):
        y_test_all = load_object("pytorch_result_train/" + mod_use + "/y_test_all")

    if os.path.isfile("pytorch_result_train/" + mod_use + "/ws_all"):
    ...
    if not os.path.isdir("pytorch_result_train/" + mod_use):
        os.makedirs("pytorch_result_train/" + mod_use)

    save_object("pytorch_result_train/" + mod_use + "/predicted_all", predicted_all)
    save_object("pytorch_result_train/" + mod_use + "/y_test_all", y_test_all)
    save_object("pytorch_result_train/" + mod_use + "/ws_all", ws_all)
    ...
    if os.path.isfile("pytorch_result_train/" + mod_use + "/predicted_long"):
        predicted_long = load_object("pytorch_result_train/" + mod_use + "/predicted_long")

    if os.path.isfile("pytorch_result_train/" + mod_use + "/predicted_lat"):
        predicted_lat = load_object("pytorch_result_train/" + mod_use + "/predicted_lat")

    if os.path.isfile("pytorch_result_train/" + mod_use + "/actual_long"):
        actual_long = load_object("pytorch_result_train/" + mod_use + "/actual_long")

    if os.path.isfile("pytorch_result_train/" + mod_use + "/actual_lat"):
    ...
    save_object("pytorch_result_train/" + mod_use + "/actual_long", actual_long)
    save_object("pytorch_result_train/" + mod_use + "/actual_lat", actual_lat)
    save_object("pytorch_result_train/" + mod_use + "/predicted_long", predicted_long)
    save_object("pytorch_result_train/" + mod_use + "/predicted_lat", predicted_lat)