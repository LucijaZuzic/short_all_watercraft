...
class Exp_All_Task(object):
    ...
    def test_long_term_forecast(self, setting, test_data, test_loader, data_task_name, task_id):
        ...
        self.model.eval()
        part_model = setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train").split("_")
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, _, _) in enumerate(test_loader):
                ...
                f_dim = -1 if features == 'MS' else 0
                xs_part = batch_x[:, -pred_len:, f_dim:]
                outputs = outputs[:, -pred_len:, f_dim:]
                batch_y = batch_y[:, -pred_len:, f_dim:]

                xs_part = xs_part.detach().cpu()
                outputs = outputs.detach().cpu()
                batch_y = batch_y.detach().cpu()
                if test_data.scale and self.args.inverse:
                    xs_part = test_data.inverse_transform(xs_part)
        ...
        if not os.path.isdir("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train")):
            os.makedirs("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train")) 
        import pickle
        with open("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train") + "/xs_" + data_task_name, 'wb') as file_object:
            pickle.dump(xs, file_object) 
            file_object.close()
        with open("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train") + "/preds_" + data_task_name, 'wb') as file_object:
            pickle.dump(preds, file_object) 
            file_object.close()
        with open("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train") + "/trues_" + data_task_name, 'wb') as file_object:
            pickle.dump(trues, file_object) 
            file_object.close()
        with open("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train") + "/xs_transformed_" + data_task_name, 'wb') as file_object:
            pickle.dump(xs_transformed, file_object) 
            file_object.close()
        with open("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train") + "/preds_transformed_" + data_task_name, 'wb') as file_object:
            pickle.dump(preds_transformed, file_object) 
            file_object.close()
        with open("results/" + setting.replace("ALL_task_UniTS_zeroshot_pretrain_x64_mine_", "").replace("_UniTS_zeroshot_All_ftM_dm64_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm128_el3_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm64_el2_Exp_0", "").replace("_UniTS_zeroshot_All_ftM_dm512_el3_Exp_0", "").replace("train_test", "train") + "/trues_transformed_" + data_task_name, 'wb') as file_object:
