...
for dn in os.listdir("UniTS_final_result/"):

    if "BLEU" in dn:
        continue

    if not os.path.isdir("mosaic_UniTS/" + dn):
        os.makedirs("mosaic_UniTS/" + dn)

    if not os.path.isdir("mosaic_UniTS_all/" + dn):
        os.makedirs("mosaic_UniTS_all/" + dn)
...
for dn in os.listdir("UniTS_final_result/"):
    ...
    if os.path.isfile("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/distance_predicted_new"):
        distance_predicted_new = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/distance_predicted_new")
    ...
    for metric in metric_names:
        ...
        predicted_all = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/predicted_all")
        y_test_all = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/y_test_all")
        ws_all = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/ws_all")

        actual_long = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/actual_long")
        actual_lat = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/actual_lat")
        predicted_long = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/predicted_long")
        predicted_lat = load_object("UniTS_final_result/" + model_name.replace("UniTS_", "") + "/predicted_lat")
                ...
                for v in set(int_veh):
                    ...
                    for k in predicted_long[model_name][ws_use][dist_name]:
                        ...
                        if use_draw:
                            ...
                            filename = "mosaic_UniTS_all/" + dn + "/Vehicle_" + vehicle + "_events_" + ride + "_" + model_name + "_" + str(ws_use) + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
                    ...
                    if use_draw:
                        ...
                        filename_veh = "mosaic_UniTS/" + dn + "/Vehicle_" + str(v) + "_" + model_name + "_" + str(ws_use) + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
                        draw_mosaic(all_actual_vehicle, all_predicted, filename_veh)

                if use_draw:

                    filename = "mosaic_UniTS/" + dn + "/all_" + model_name + "_" + str(ws_use) + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
    ...
    save_object("UniTS_final_result/" + dn + "/distance_predicted_new", distance_predicted_new)
