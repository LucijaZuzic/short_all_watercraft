...
for nf1 in range(sf1):
    ...
    for nf2 in range(sf2):
        ...
        for dn in os.listdir("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/"):

            if "BLEU" in dn:
                continue

            if not os.path.isdir("mosaic_UniTS/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn):
                os.makedirs("mosaic_UniTS/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn)

            if not os.path.isdir("mosaic_UniTS_all/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn):
                os.makedirs("mosaic_UniTS_all/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn)
...
for nf1 in range(sf1):
    ...
    for nf2 in range(sf2):
        ...
        for dn in os.listdir("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/"):
            ...
            if os.path.isfile("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/distance_predicted_new"):
                distance_predicted_new = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/distance_predicted_new")
            ...
            for metric in metric_names:
                ...
                predicted_all = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/predicted_all")
                y_test_all = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/y_test_all")
                ws_all = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/ws_all")

                actual_long = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/actual_long")
                actual_lat = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/actual_lat")
                predicted_long = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/predicted_long")
                predicted_lat = load_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + model_name.replace("UniTS_", "") + "/predicted_lat")
                    ...
                    for dist_name in predicted_long[model_name][ws_use]:
                        ...
                        for v in set(int_veh):
                            ...
                            for k in predicted_long[model_name][ws_use][dist_name]:
                                ...
                                if use_draw and not os.path.isdir("mosaic_UniTS_all/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn + "/"):

                                    filename = "mosaic_UniTS_all/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn + "/Vehicle_" + vehicle + "_events_" + ride + "_" + model_name + "_" + str(ws_use) + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
                            ...
                            if use_draw and not os.path.isdir("mosaic_UniTS/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn + "/"):

                                filename_veh = "mosaic_UniTS/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn + "/Vehicle_" + str(v) + "_" + model_name + "_" + str(ws_use) + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
                                draw_mosaic(all_actual_vehicle, all_predicted, filename_veh)

                        if use_draw and not os.path.isdir("mosaic_UniTS/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn + "/"):

                            filename = "mosaic_UniTS/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn + "/all_" + model_name + "_" + str(ws_use) + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
            ...
            save_object("UniTS_final_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + dn + "/distance_predicted_new", distance_predicted_new)
