...
for dirnam in os.listdir("UniTS_final_res_val"):
    ...
    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/BLEU_all"):
        BLEU_all = load_object("UniTS_final_result_val/" + dirnam + "/BLEU_all")
    ...
    for varname in ["speed", "direction", "longitude_no_abs", "latitude_no_abs", "time"]:
        ...
        for ws_use in ws_range:
            ...
            save_object("UniTS_final_result_val/BLEU_all", BLEU_all) 
