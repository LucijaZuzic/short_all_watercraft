...
dicti_all = load_object("dicti_all_val")
        ...
        if "R2" in metric_name_use:
            ...
            for val_ws in list_ws:
                ...
                if max_col[val_ws] > max_max:
                    ...
                    max_max_ws = val_ws
                strnew = "The highest " + translate_metric[metric_name_use] + " value of $" + max_col_str[val_ws] + "$ for the " + translate_varname[varname] + " estimated using validation data, a window size of " + translate_ws[str(val_ws)] + " seconds was achieved with the " + translate_model[max_col_ix[val_ws]] + "."
                #print(strnew)
            strnew = "The highest " + translate_metric[metric_name_use] + " value of $" + max_max_str + "$ for the estimated validation data " + translate_varname[varname] + " was achieved using a window size of " + translate_ws[str(max_max_ws)] + " seconds and the " + translate_model[max_max_ix] + "."
            print(strnew)
        else:
            min_min = 1000000
            min_min_ix = -1
            ...
            for val_ws in list_ws:
                ...
                if min_col[val_ws] < min_min:
                    ...
                    min_min_ws = val_ws
                strnew = "The lowest " + translate_metric[metric_name_use] + " value of $" + min_col_str[val_ws] + "$ for the " + translate_varname[varname] + " estimated using validation data, a window size of " + translate_ws[str(val_ws)] + " seconds was achieved with the " + translate_model[min_col_ix[val_ws]] + "."
                #print(strnew)
            strnew = "The lowest " + translate_metric[metric_name_use] + " value of $" + min_min_str + "$ for the estimated validation data " + translate_varname[varname] + " was achieved using a window size of " + translate_ws[str(min_min_ws)] + " seconds and the " + translate_model[min_min_ix] + "."
            print(strnew)