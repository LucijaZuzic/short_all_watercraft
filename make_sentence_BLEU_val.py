...
dicti_all = load_object("dicti_all_BLEU_val")
    ...
    for varname in vartouse:
        ...
        for val_ws in list_ws:
            ...
            if max_col[val_ws] > max_max:
                ...
                max_max_ws = val_ws
            strnew = "The highest " + translate_metric[metric_name_use] + " score of $" + max_col_str[val_ws] + "$ for the " + translate_varname[varname] + " estimated using validation data, a window size of " + translate_ws[str(val_ws)] + " seconds was achieved with the " + translate_model[max_col_ix[val_ws]] + ', and falls into the "' + get_cat(max_col[val_ws]) + '" category.'
            #print(strnew)
        strnew = "The highest " + translate_metric[metric_name_use] + " score of $" + max_max_str + "$ for the estimated validation data " + translate_varname[varname] + " was achieved using a window size of " + translate_ws[str(max_max_ws)] + " seconds and the " + translate_model[max_max_ix] + ' and falls into the "' + get_cat(max_max) + '" category.'
        print(strnew)