...
if os.path.isfile("attention_result_train/predicted_all"):
    predicted_all = load_object("attention_result_train/predicted_all")
    
if os.path.isfile("attention_result_train/y_test_all"):
    y_test_all = load_object("attention_result_train/y_test_all")

if os.path.isfile("attention_result_train/ws_all"):
...
for varname in os.listdir("train_attention1"):
    ...
    for test_num in range(1, 69):
        ...
        final_test_data = pd.read_csv("train_attention" + str(test_num) + "/" + varname + "/predictions/train/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + "_train.csv", sep = ";", index_col = False)
...
if not os.path.isdir("attention_result_train"):
    os.makedirs("attention_result_train")

save_object("attention_result_train/predicted_all", predicted_all)
save_object("attention_result_train/y_test_all", y_test_all)
save_object("attention_result_train/ws_all", ws_all)
...
if os.path.isfile("attention_result_train/predicted_long"):
    predicted_long = load_object("attention_result_train/predicted_long")

if os.path.isfile("attention_result_train/predicted_lat"):
    predicted_lat = load_object("attention_result_train/predicted_lat")

if os.path.isfile("attention_result_train/actual_long"):
    actual_long = load_object("attention_result_train/actual_long")

if os.path.isfile("attention_result_train/actual_lat"):
...
save_object("attention_result_train/actual_long", actual_long)
save_object("attention_result_train/actual_lat", actual_lat)
save_object("attention_result_train/predicted_long", predicted_long)
save_object("attention_result_train/predicted_lat", predicted_lat)