...
for nf1 in range(sf1):
    for nf2 in range(sf2):
        ...
        for s in setse:
            ...
            if not os.path.isdir("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + s + "/"):
                os.makedirs("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + s + "/")

            dfnewtrain.to_csv("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + s + "/newdata_TRAIN.csv", index = False, sep = ",") 
            dfnewval.to_csv("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + s + "/newdata_VAL.csv", index = False, sep = ",") 
            dfnewtest.to_csv("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + s + "/newdata_TEST.csv", index = False, sep = ",") 
            dfnewtrainval.to_csv("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + s + "/newdata_TRAIN_VAL.csv", index = False, sep = ",") 
            dfnewall.to_csv("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + s + "/newdata_ALL.csv", index = False, sep = ",") 
        ...
        for sth in setse:
            ...
            for ws_use in ws_range:
                ...
                dictiowt = {"task_name": "pretrain_long_term_forecast", 
                            ...
                            "data": "custom", 
                            "embed": "timeF", 
                            "root_path": "retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/dataset/" + sth + "/", 
                ...
                if not os.path.isdir("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use)):
                    os.makedirs("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use))

                file_yml_pre_write = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/"+ str(ws_use) + "/multi_task_pretrain.yaml", "w")
                file_yml_pre_write.write(yml_part[sth][ws_use])
                file_yml_pre_write.close()

                file_yml_pre_write_all = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/multi_task_pretrain_all.yaml", "w")
                file_yml_pre_write_all.write(yml_part[sth][ws_use].replace("TRAIN", "ALL"))
                file_yml_pre_write_all.close()
                
                file_yml_pre_write_val = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/multi_task_pretrain_val.yaml", "w")
                file_yml_pre_write_val.write(yml_part[sth][ws_use].replace("TRAIN", "TRAIN_VAL"))
                file_yml_pre_write_val.close()
                
                file_yml_pre_write_valo = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/multi_task_pretrain_valonly.yaml", "w")
                file_yml_pre_write_valo.write(yml_part[sth][ws_use].replace("TRAIN", "VAL"))
                file_yml_pre_write_valo.close()

                file_yml_pre_write_test = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/multi_task_pretrain_test.yaml", "w")
                file_yml_pre_write_test.write(yml_part[sth][ws_use].replace("TRAIN", "TEST"))
                file_yml_pre_write_test.close()
            
                file_yml_write = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/"+ str(ws_use) + "/zeroshot_task.yaml", "w")
                file_yml_write.write(yml_part[sth][ws_use].replace("pretrain_", ""))
                file_yml_write.close()

                file_yml_write_all = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/zeroshot_task_all.yaml", "w")
                file_yml_write_all.write(yml_part[sth][ws_use].replace("pretrain_", "").replace("TRAIN", "ALL"))
                file_yml_write_all.close()
                
                file_yml_write_val = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/zeroshot_task_val.yaml", "w")
                file_yml_write_val.write(yml_part[sth][ws_use].replace("pretrain_", "").replace("TRAIN", "TRAIN_VAL"))
                file_yml_write_val.close()
                
                file_yml_write_valo = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/zeroshot_task_valonly.yaml", "w")
                file_yml_write_valo.write(yml_part[sth][ws_use].replace("pretrain_", "").replace("TRAIN", "VAL"))
                file_yml_write_valo.close()

                file_yml_write_test = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + sth + "/" + str(ws_use) + "/zeroshot_task_test.yaml", "w")
        ...
        for ws_use in ws_range:
            ...
            for vd in yml_part_merged12:
                ...
                if not os.path.isdir("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use)):
                    os.makedirs("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use))

                file_yml_pre_write = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/"+ str(ws_use) + "/multi_task_pretrain.yaml", "w")
                file_yml_pre_write.write(yml_part_merged12[vd])
                file_yml_pre_write.close()

                file_yml_pre_write_all = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/multi_task_pretrain_all.yaml", "w")
                file_yml_pre_write_all.write(yml_part_merged12[vd].replace("TRAIN", "ALL"))
                file_yml_pre_write_all.close()
                
                file_yml_pre_write_val = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/multi_task_pretrain_val.yaml", "w")
                file_yml_pre_write_val.write(yml_part_merged12[vd].replace("TRAIN", "TRAIN_VAL"))
                file_yml_pre_write_val.close()
                
                file_yml_pre_write_valo = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/multi_task_pretrain_valonly.yaml", "w")
                file_yml_pre_write_valo.write(yml_part_merged12[vd].replace("TRAIN", "VAL"))
                file_yml_pre_write_valo.close()

                file_yml_pre_write_test = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/multi_task_pretrain_test.yaml", "w")
                file_yml_pre_write_test.write(yml_part_merged12[vd].replace("TRAIN", "TEST"))
                file_yml_pre_write_test.close()
            
                file_yml_write = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/"+ str(ws_use) + "/zeroshot_task.yaml", "w")
                file_yml_write.write(yml_part_merged12[vd].replace("pretrain_", ""))
                file_yml_write.close()

                file_yml_write_all = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/zeroshot_task_all.yaml", "w")
                file_yml_write_all.write(yml_part_merged12[vd].replace("pretrain_", "").replace("TRAIN", "ALL"))
                file_yml_write_all.close()
                
                file_yml_write_val = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/zeroshot_task_val.yaml", "w")
                file_yml_write_val.write(yml_part_merged12[vd].replace("pretrain_", "").replace("TRAIN", "TRAIN_VAL"))
                file_yml_write_val.close()
                
                file_yml_write_valo = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/zeroshot_task_valonly.yaml", "w")
                file_yml_write_valo.write(yml_part_merged12[vd].replace("pretrain_", "").replace("TRAIN", "VAL"))
                file_yml_write_valo.close()

                file_yml_write_test = open("retry/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/data_provider/" + vd + "/" + str(ws_use) + "/zeroshot_task_test.yaml", "w")
