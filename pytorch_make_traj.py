...
for mod_use in modes:
    ...
    if os.path.isfile("pytorch_result/" + mod_use + "/predicted_all"):
        predicted_all = load_object("pytorch_result/" + mod_use + "/predicted_all")
        
    if os.path.isfile("pytorch_result/" + mod_use + "/y_test_all"):
        y_test_all = load_object("pytorch_result/" + mod_use + "/y_test_all")

    if os.path.isfile("pytorch_result/" + mod_use + "/ws_all"):
        ...
        for model_name_short in model_list:
            ...
            for ws_use in ws_range:
                ...
                for hidden_use in hidden_range:
                    ...
                    final_test_data = pd.read_csv("train_pytorch/" + mod_use + "/" + varname + "/predictions/test/" + model_name_short + "/" + varname + "_" + model_name_short + "_ws_" + str(ws_use) + "_hidden_" + str(hidden_use) + "_test.csv", sep = ";", index_col = False)
    ...
    if not os.path.isdir("pytorch_result/" + mod_use):
        os.makedirs("pytorch_result/" + mod_use)

    save_object("pytorch_result/" + mod_use + "/predicted_all", predicted_all)
    save_object("pytorch_result/" + mod_use + "/y_test_all", y_test_all)
    save_object("pytorch_result/" + mod_use + "/ws_all", ws_all)
    ...
    if os.path.isfile("pytorch_result/" + mod_use + "/predicted_long"):
        predicted_long = load_object("pytorch_result/" + mod_use + "/predicted_long")

    if os.path.isfile("pytorch_result/" + mod_use + "/predicted_lat"):
        predicted_lat = load_object("pytorch_result/" + mod_use + "/predicted_lat")

    if os.path.isfile("pytorch_result/" + mod_use + "/actual_long"):
        actual_long = load_object("pytorch_result/" + mod_use + "/actual_long")

    if os.path.isfile("pytorch_result/" + mod_use + "/actual_lat"):
    ...
    save_object("pytorch_result/" + mod_use + "/actual_long", actual_long)
    save_object("pytorch_result/" + mod_use + "/actual_lat", actual_lat)
    save_object("pytorch_result/" + mod_use + "/predicted_long", predicted_long)
    save_object("pytorch_result/" + mod_use + "/predicted_lat", predicted_lat)