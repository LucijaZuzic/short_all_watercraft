...
for dirnam in os.listdir("UniTS_final_res_train"):
    ...
    if not os.path.isdir("UniTS_final_result_train/" + dirnam):
        os.makedirs("UniTS_final_result_train/" + dirnam)

    save_object("UniTS_final_result_train/" + dirnam + "/predicted_all", predicted_all)
    save_object("UniTS_final_result_train/" + dirnam + "/y_test_all", y_test_all)
    save_object("UniTS_final_result_train/" + dirnam + "/ws_all", ws_all)
    ...
    if os.path.isfile("UniTS_final_result_train/" + dirnam + "/predicted_long"):
        predicted_long = load_object("UniTS_final_result_train/" + dirnam + "/predicted_long")

    if os.path.isfile("UniTS_final_result_train/" + dirnam + "/predicted_lat"):
        predicted_lat = load_object("UniTS_final_result_train/" + dirnam + "/predicted_lat")

    if os.path.isfile("UniTS_final_result_train/" + dirnam + "/actual_long"):
        actual_long = load_object("UniTS_final_result_train/" + dirnam + "/actual_long")

    if os.path.isfile("UniTS_final_result_train/" + dirnam + "/actual_lat"):
        actual_lat = load_object("UniTS_final_result_train/" + dirnam + "/actual_lat")
    ...
    if not os.path.isdir("UniTS_final_result_train"):
        os.makedirs("UniTS_final_result_train")

    save_object("UniTS_final_result_train/" + dirnam + "/actual_long", actual_long)
    save_object("UniTS_final_result_train/" + dirnam + "/actual_lat", actual_lat)
    save_object("UniTS_final_result_train/" + dirnam + "/predicted_long", predicted_long)
    save_object("UniTS_final_result_train/" + dirnam + "/predicted_lat", predicted_lat)