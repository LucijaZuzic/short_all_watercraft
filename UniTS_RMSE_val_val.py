...
dicti_all_val = dict()
if os.path.isfile("dicti_all_val"):
    dicti_all_val = load_object("dicti_all_val")
    ...
    for varname in dicti_to_print:
        ...
        for model_name_use in dicti_to_print[varname]:
            ...
            for val_ws in list_ws: 
                ...
                if varname not in dicti_all_val:
                    dicti_all_val[varname] = dict()
                if model_name_use not in dicti_all_val[varname]:
                    dicti_all_val[varname][model_name_use] = dict()
                if str(val_ws) not in dicti_all_val[varname][model_name_use]:
                    dicti_all_val[varname][model_name_use][str(val_ws)] = dict()
                if metric_name_use not in dicti_all_val[varname][model_name_use][str(val_ws)]:
                    dicti_all_val[varname][model_name_use][str(val_ws)][metric_name_use] = dict()
                dicti_all_val[varname][model_name_use][str(val_ws)][metric_name_use] = vv
...
save_object("dicti_all_val", dicti_all_val)