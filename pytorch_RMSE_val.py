        ...
        for model_name in model_list:
            for ws_use in ws_range:
                for hidden_use in hidden_range:
                    ...
                    final_test_data = pd.read_csv("train_pytorch/" + mod_use + "/" + varname + "/predictions/test/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + "_hidden_" + str(hidden_use) + "_test.csv", sep = ";", index_col = False)
