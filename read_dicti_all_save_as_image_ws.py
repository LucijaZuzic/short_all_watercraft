    ...
    for varname in vartouse:
        ...
        while too_small or duplicate_val_all:
            ...
            if rv_metric > 3 or mul_metric > 6:
                break
        if not os.path.isdir("new_img_ws"):
            os.makedirs("new_img_ws")
        ...
        for nf1 in range(sf1):
            ...
            if nf1 == sf1 - 1:
                ...
                plt.legend(ncol = 2)
        plt.savefig("new_img_ws/" + metric_name_use + "_" + varname + ".png", bbox_inches = "tight")
        plt.close()
        ...
        newstart = start_of_table.replace("FILENAME", "new_img_ws/" + metric_name_use + "_" + varname + ".png")
