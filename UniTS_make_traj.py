...
for dirnam in os.listdir("UniTS_final_res"):
    ...
    if os.path.isfile("UniTS_final_result/" + dirnam + "/predicted_all"):
        predicted_all = load_object("UniTS_final_result/" + dirnam + "/predicted_all")
        
    if os.path.isfile("UniTS_final_result/" + dirnam + "/y_test_all"):
        y_test_all = load_object("UniTS_final_result/" + dirnam + "/y_test_all")

    if os.path.isfile("UniTS_final_result/" + dirnam + "/ws_all"):
        ws_all = load_object("UniTS_final_result/" + dirnam + "/ws_all")
    ...
    if not os.path.isdir("UniTS_final_result/" + dirnam):
        os.makedirs("UniTS_final_result/" + dirnam)

    save_object("UniTS_final_result/" + dirnam + "/predicted_all", predicted_all)
    save_object("UniTS_final_result/" + dirnam + "/y_test_all", y_test_all)
    save_object("UniTS_final_result/" + dirnam + "/ws_all", ws_all)
    ...
    if os.path.isfile("UniTS_final_result/" + dirnam + "/predicted_long"):
        predicted_long = load_object("UniTS_final_result/" + dirnam + "/predicted_long")

    if os.path.isfile("UniTS_final_result/" + dirnam + "/predicted_lat"):
        predicted_lat = load_object("UniTS_final_result/" + dirnam + "/predicted_lat")

    if os.path.isfile("UniTS_final_result/" + dirnam + "/actual_long"):
        actual_long = load_object("UniTS_final_result/" + dirnam + "/actual_long")

    if os.path.isfile("UniTS_final_result/" + dirnam + "/actual_lat"):
        actual_lat = load_object("UniTS_final_result/" + dirnam + "/actual_lat")
    ...
    save_object("UniTS_final_result/" + dirnam + "/actual_long", actual_long)
    save_object("UniTS_final_result/" + dirnam + "/actual_lat", actual_lat)
    save_object("UniTS_final_result/" + dirnam + "/predicted_long", predicted_long)
    save_object("UniTS_final_result/" + dirnam + "/predicted_lat", predicted_lat)