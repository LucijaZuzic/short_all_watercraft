...
for nf1 in range(sf1):
    ...
    for nf2 in range(sf2):
        ...
        if os.path.isfile("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/predicted_lat"):
            continue
        else:
            print(str(nf1 + 1) + "/" + str(nf2 + 1))

        if os.path.isfile("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/predicted_all"):
            predicted_all = load_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/predicted_all")
            
        if os.path.isfile("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/y_test_all"):
            y_test_all = load_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/y_test_all")

        if os.path.isfile("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/ws_all"):
        ...
        for varname in ["speed", "direction", "longitude_no_abs", "latitude_no_abs", "time"]:
            ...
            for test_num in range(1, 69):
                ...
                if varname != "time":
                    ...
                    print("train_attention" + str(test_num) + "/"+ str(nf1 + 1) + "/" + str(nf2 + 1) + "/" + varname + "/predictions/test/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + "_test.csv")
                ...
                for k in file_object_test:
                    ...
                    if varname != "time":
                        ...
                        predicted_all[varname][model_name][test_num][k] = y_test_all[varname][model_name][test_num][k]

                    len_total += len(y_test_all[varname][model_name][test_num][k])  

        if not os.path.isdir("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1)):
            os.makedirs("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1))

        save_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/predicted_all", predicted_all)
        save_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/y_test_all", y_test_all)
        save_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/ws_all", ws_all)
        ...
        if os.path.isfile("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/predicted_long"):
        ...
        if os.path.isfile("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_long"):
            actual_long = load_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_long")

        if os.path.isfile("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_lat"):
        ...
        save_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_long", actual_long)
        save_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/actual_lat", actual_lat)
        save_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/predicted_long", predicted_long)
        save_object("attention_result/" + str(nf1 + 1) + "/" + str(nf2 + 1) + "/predicted_lat", predicted_lat)