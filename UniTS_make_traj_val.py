...
for dirnam in os.listdir("UniTS_final_res_val"):

    model_name = "UniTS_" + dirnam

    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/predicted_all"):
        predicted_all = load_object("UniTS_final_result_val/" + dirnam + "/predicted_all")
        
    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/y_test_all"):
        y_test_all = load_object("UniTS_final_result_val/" + dirnam + "/y_test_all")

    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/ws_all"):
        ws_all = load_object("UniTS_final_result_val/" + dirnam + "/ws_all")
    ...
    for varname in ["speed", "direction", "longitude_no_abs", "latitude_no_abs", "time"]:
        ...
        for ws_use in ws_range:
            ...
            if varname != "time":
                ...
                final_test_data = pd.read_csv("UniTS_final_res_val/" + dirnam + "/" + str(ws_use) + "/" + varname + ".csv", index_col = False)

            else:
            
                final_test_data = pd.read_csv("UniTS_final_res_val/" + dirnam.replace("longlat", "offsets") + "/" + str(ws_use) + "/" + varname + ".csv", index_col = False)
    ...
    if not os.path.isdir("UniTS_final_result_val/" + dirnam):
        os.makedirs("UniTS_final_result_val/" + dirnam)

    save_object("UniTS_final_result_val/" + dirnam + "/predicted_all", predicted_all)
    save_object("UniTS_final_result_val/" + dirnam + "/y_test_all", y_test_all)
    save_object("UniTS_final_result_val/" + dirnam + "/ws_all", ws_all)
    ...
    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/predicted_long"):
        predicted_long = load_object("UniTS_final_result_val/" + dirnam + "/predicted_long")

    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/predicted_lat"):
        predicted_lat = load_object("UniTS_final_result_val/" + dirnam + "/predicted_lat")

    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/actual_long"):
        actual_long = load_object("UniTS_final_result_val/" + dirnam + "/actual_long")

    if os.path.isfile("UniTS_final_result_val/" + dirnam + "/actual_lat"):
        actual_lat = load_object("UniTS_final_result_val/" + dirnam + "/actual_lat")
    ...
    if not os.path.isdir("UniTS_final_result_val"):
        os.makedirs("UniTS_final_result_val")

    save_object("UniTS_final_result_val/" + dirnam + "/actual_long", actual_long)
    save_object("UniTS_final_result_val/" + dirnam + "/actual_lat", actual_lat)
    save_object("UniTS_final_result_val/" + dirnam + "/predicted_long", predicted_long)
    save_object("UniTS_final_result_val/" + dirnam + "/predicted_lat", predicted_lat)